...
- [`T0028-malformed-frontmatter-indexing-recovery.md`](T0028-malformed-frontmatter-indexing-recovery.md): malformed YAML 원문 보존 색인 복구. Updated: 2026-09-13.
...
- [`T0027-m4-rag-embedding-production-cutover.md`](T0027-m4-rag-embedding-production-cutover.md): Local RAG v1.3.1의 M4 query/bulk 인증 전환, embedding-only 경계와 rollback continuity 완료. Updated: 2026-09-05.
- [`T0026-m4-rag-query-bulk-zone-binding.md`](T0026-m4-rag-query-bulk-zone-binding.md): M4 RAG query/bulk authenticated binding, 4B/2560 provenance와 checkpoint-safe publication source/test 완료. Updated: 2026-09-04.
